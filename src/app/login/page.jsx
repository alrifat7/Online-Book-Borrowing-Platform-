    ...
    return (
        ...
        <div className="pointer-events-none fixed inset-0">
            <div className="absolute -top-48 -right-48 w-[600px] h-[600px] rounded-full bg-amber-400/[0.07] blur-3xl" />
            <div className="absolute -bottom-48 -left-48 w-[500px] h-[500px] rounded-full bg-orange-500/[0.05] blur-3xl" />
            <div
        ...
        <div className="relative z-10 w-full max-w-[420px] rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl shadow-[0_40px_80px_rgba(0,0,0,0.5)] px-10 py-12">
            ...
            <span className="font-bold text-white text-[1.15rem] tracking-tight">
            ...
            <button
                type="submit"
                className="w-full py-3.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-900 text-sm font-semibold transition-colors shadow-md shadow-amber-500/20"
            >
                Sign In
            </button>
            </form>
