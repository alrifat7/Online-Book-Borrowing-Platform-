    ...
    // ─── Mock auth hook ────────────────────────────────────────────────────────────
    // Replace this with your real BetterAuth session hook:
    // import { useSession } from "@/lib/auth-client";
    function useMockSession() {
    const [session, setSession] = useState(null);
    // Toggle to true to preview logged-in state during development
    // setSession({ user: { name: "Rahim Uddin", image: null } });
    ...
    // ── Dev-only toggle (remove in production) ──
    const toggleAuth = () =>
        setSession((s) =>
        s ? null : { user: { name: "Rahim Uddin", image: null } }
        );
